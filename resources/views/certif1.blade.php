...
<body>
    <div style="width: 100%; position: absolute;margin: 0">
        <img src="{{ asset('certificate_blanks/1.jpg') }}" class="certificate-image" alt="">
    ...
    <div style="position: relative; padding: 0;padding-top: 50px; text-align: center;">
        ...
        <span class="certificate-text">for successfully completing the course of
        </span><br><br><br>
        <span class="certificate-text">{{ $data->participant->training }}</span><br><br><br>
